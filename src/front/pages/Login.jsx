            ...
            <div className="col-6 mx-auto mt-5">
                ...
                <ul className="nav nav-pills nav-fill m-3" id="pills-tab" role="tablist">
                    <li className="nav-item" role="presentation">
                        <button
                            className={`nav-link ${selectedRole === "usuario" ? "active" : ""}`}
                            id="pills-usuario-tab"

                            onClick={() => setSelectedRole("usuario")}
                            type="button"
                            role="tab"
                            aria-controls="pills-usuario"
                            aria-selected={selectedRole === "usuario"}
                        >Usuario</button>
                    </li>
                    <li className="nav-item" role="presentation">
                        <button
                            ...
                            role="tab"
                            aria-controls="pills-usuario"
                            aria-selected={selectedRole === "empresa"}>Empresa</button>
                    </li>
                </ul>
