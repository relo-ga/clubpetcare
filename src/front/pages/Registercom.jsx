    ...
    <main className="col-4 form-signin m-auto">
      <div >
        <div className="d-flex justify-content-center">
          ...
          <h1 className="h3 m-4 my-auto fw-normal open-sans-body">Offer your services!!🎉</h1>
        </div>

        <div className="form-floating my-2 mx-5">
          <input type="text" className="form-control text-center sour-gummy-head" id="user_name" placeholder="User Name"
            onChange={handleInputChange} name="name"
          />
          <label className="sour-gummy-head" htmlFor="floatingInput">User Name</label>
        </div>
        <div className="form-floating my-2 mx-5">
          ...
          />
          <label className="sour-gummy-head" htmlFor="floatingInput">Company Name</label>
        </div>
        <div className="form-floating my-2 mx-5">
        ...
        <div className="form-floating my-2 mx-5">
          ...
          />
          <label className="sour-gummy-head" htmlFor="floatingPassword">Confirm Password</label>
        </div>
